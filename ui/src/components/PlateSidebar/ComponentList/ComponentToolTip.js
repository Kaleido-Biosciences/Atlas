        ...
        return (
          <List>
            ...
            {component.data.glycanComposition ?
              <List.Item><List.Header>Glycan composition</List.Header>{component.data.glycanComposition}
              </List.Item> : ''
            }
            ...
            {component.data.dateCreated ?
              <List.Item><List.Header>Created date</List.Header>{this.formatDate(component.data.dateCreated)}
              </List.Item> : ''
            }
        ...
        return (
          <List>
            {component.data.registrationDate ?
              <List.Item><List.Header>Registration date</List.Header>{this.formatDate(component.data.registrationDate)}
              </List.Item> : ''
            }
